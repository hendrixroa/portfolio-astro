...
You can change global site configuration on '/src/schemas.ts' file:
...
You can add a [content collection](https://docs.astro.build/en/guides/content-collections/) in `/content/' folder, you will need add it at schemas.ts.
